package net.mostlyoriginal.game.system.view.render;

import net.mostlyoriginal.game.component.render.CustomShader;
import net.mostlyoriginal.game.component.render.DecalComponent;
import net.mostlyoriginal.game.component.render.ModelSetComponent;
import net.mostlyoriginal.game.component.render.Renderable;
import net.mostlyoriginal.game.system.view.render.renderers.DecalRenderer;
import net.mostlyoriginal.game.system.view.render.renderers.SpriteRenderer;
